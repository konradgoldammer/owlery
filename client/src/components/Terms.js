...
const Terms = () => {
  return (
    <div className="terms-container">
      ...
      <p>Welcome to Owlery!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Owlery's Website, located at http://www.owlery.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Owlery if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Owlery, you agreed to use
        cookies in agreement with the Owlery's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Owlery and/or its licensors own the
        intellectual property rights for all material on Owlery. All
        intellectual property rights are reserved. You may access this from
        Owlery for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Owlery</li>
        <li>Sell, rent or sub-license material from Owlery</li>
        <li>Reproduce, duplicate or copy material from Owlery</li>
        <li>Redistribute content from Owlery</li>
      </ul>
      ...
      <p>
        ...
        Owlery does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Owlery,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Owlery shall not be liable for the
      ...
      <p>
        Owlery reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Owlery a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Owlery; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Owlery. Please include your name, your organization name,
      ...
      <p>
        No use of Owlery's logo or other artwork will be allowed for linking
